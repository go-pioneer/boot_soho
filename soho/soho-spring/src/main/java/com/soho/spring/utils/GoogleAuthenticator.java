...
public class GoogleAuthenticator {
    ...
    public static String generateSecretKey(int len) {
        ...
        try {
            ...
            byte[] buffer = sr.generateSeed(len);
    ...
    private static String s = "RODEOQFC6E5VY3I5SOGZCVKA7QT7MXBG6RU3Y2RY4EP2CVYC";

    private static int code = 511855;

    public static void main(String[] args) throws InterruptedException {
        for (; ; ) {
            GoogleAuthenticator authenticator = new GoogleAuthenticator();
            authenticator.setWindowSize(2);
            boolean result = authenticator.check_code(s, code, System.currentTimeMillis());
